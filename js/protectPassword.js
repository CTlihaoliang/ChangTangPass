...
;(function ($) {
    $.fn.securePassword = function () {
        ...
        var point = function (input) {
            ...
            if ($(document).height() - input.offset().top - $(document).scrollTop() - h - 157 > 0 || input.offset().top < 157) {
                return {
                    top: y + h-1,
                    left: x
                }
        ...
        var loadSecureDom = function () {
            ...
            obj.appendTo($("body"));
            if(ie67){
                 $('<iframe data-id='+ id + ' src="" frameBorder="0" scrolling="no" height="155px" width="220px" style="display:none;position:absolute;left: ' + p.left + 'px;top:' + p.top + 'px;"z-index":100></iframe>').appendTo($("body"));
            }
        ...
        $(this).each(function () {
            ...
            $(this).bind({
                "focus": function () {
                    ...
                    //var url = "http://user.ct108.org:1906/SecurePwdImage.html?uuid=" + uuid;
